...
/*CLI User Interface has been implemented as per the specification i.e. these commands below can be used as it was laid out in the PDF
  ...
  */
    ...
    class Program{
            ...
            while(true){
                ...
                if(first.ToUpper().Equals("ADD")){
                   AddingFacialFeatures(ar[1].Replace("{","").Replace("}",""));
                    ...
                    RemovingFacialFeatures(ar[1].Replace("{","").Replace("}",""));
                    ...
                    if(face.ToString().Length>0){
                        ...
                        File.WriteAllText(filePath,var);string [] tempar= File.ReadAllLines(filePath);
            ...
            if(second.Contains("|")){
                ...
                foreach(var i in temporary){
                    ...
                    if(count >= 7) Console.WriteLine("Sorry can't add any more features. 5 is the max!(excluding the face)");
                        ...
                        user.Action(new AddShapeCommand( new LeftEyeDecorator(new Circle()), face),null);
                    }else if(i.Equals("right-eye")||i.Equals("Right-Eye")){
                        user.Action(new AddShapeCommand( new RightEyeDecorator(new Circle()), face),null);
                    }else if(i.Equals("mouth")||i.Equals("Mouth")){
                        user.Action(new AddShapeCommand( new MouthDecorator(new Path()), face),null);
                    }else if(i.Equals("left-brow")||i.Equals("Left-Brow")){
                        user.Action(new AddShapeCommand( new LeftBrowDecorator(new Path()), face),null);
                    }else if(i.Equals("right-brow")||i.Equals("Right-Brow")){
                        user.Action(new AddShapeCommand(new RightBrowDecorator(new Path()), face),null);
                    }else{
        ...
        public static void RemovingFacialFeatures(string toRemove){
            if(toRemove.Contains("|")){
                ...
                foreach(var j in temppp){
                    ...
                    if(!foun) Console.WriteLine("The " + j+" cannot be removed");
                        ...
                        user.Action(new AddShapeCommand(door,face),"remove");
                        real.RemoveAt(pos);
        ...
        public static void ResetFace(){
            ...
            foreach( var i in somany){
                if(i.ToString().Equals("Circle")){newar1.Add(i);}
